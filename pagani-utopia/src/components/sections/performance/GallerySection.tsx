      ...
      <div className="relative z-10 mx-auto w-[94vw]">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          <button
            ...
            className="rounded-full border border-white/25 bg-white/10 px-5 py-3 font-mono text-[10px] tracking-[0.22em] text-cream uppercase backdrop-blur transition hover:border-gold hover:text-gold"
          >
