...
The specification sheet displays verified Pagani Utopia data:

- **Engine**: 6.0L V12 naturally aspirated — 864 PS at 8,000 rpm
- **Torque**: 900 Nm at 5,900 rpm
- **Weight**: 1,280 kg (DIN empty)
- **0–100 km/h**: 2.9 sec
- **Top speed**: 355 km/h
- **Transmission**: 7-speed AMT or 6-speed manual
- **Drive**: Rear-wheel drive with Torsen LSD
- **Brakes**: Brembo carbon-ceramic — 380mm front & rear

---

## 🤝 Technical Partners

AMG · Arrow · ART · ASPA · Brembo · Bosch · Pirelli

---

*Built for the Pagani Utopia — the art of performance.*
